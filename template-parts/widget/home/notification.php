						...
						<?php foreach ($data as $key => $item) : ?>
							<div class="swiper-slide">
								...
								<div class="flex flex-row space-x-2 items-center ">
									<div class="h-8 w-8 flex items-center justify-center"><img class="rounded-full  overflow-hidden border-white border-2 shadow lazy" data-src="<?php echo $u_avatar; ?>" alt="<?php bloginfo('name') ?>"></div>
