  ...
  <?php else : ?>
    ...
    <div class="hide-buy-warp">
      <?php if ($is_user_login_get_status) : ?>
        ...
        <div class="buy-btns">
          <a rel="nofollow noopener noreferrer" href="<?php echo esc_url(wp_login_url(get_current_url())); ?>" class="btn btn-info px-4 rounded-pill"><i class="far fa-user me-1"></i><?php _e('登录后查看', 'ripro'); ?></a>
        </div>
          ...
          <ul class="prices-info">
            ...
            foreach ($post_price_data as $type => $coin_price) {
              ...
              if ($coin_price === false) {
                ...
                $__price_span = '<span><i class="fas ' . '金币' . ' me-1"></i>' . $coin_price . '金币' . '<sup class="ms-1">' . sprintf(__('%s折', 'ripro'), $__rate) . '<sup></span>';
              } else {
