...
<div class="archive-hero post-hero text-center  overflow-hidden text-white">
    <div class="archive-hero-bg lazy overflow-hidden w-full h-full bg-no-repeat bg-cover bg-center " style="background-image:url(<?php echo $bg_image; ?>);" data-bg="<?php echo $bg_image; ?>">
