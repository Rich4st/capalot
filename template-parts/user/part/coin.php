		...
		<div class="card-body">
			...
			<form class="w-64 flex flex-col mx-auto" id="vip-cdk-action">
				...
				<div class="flex flex-row space-x-2 mb-3">
					...
					<img id="captcha-img" class="rounded-2 w-full h-8 bg-[#cacaca]  text-white mx-2 rounded lazy" role="button" data-src="<?php echo get_template_directory_uri() ?>/assets/img/captcha.png" title="<?php _e('点击刷新验证码', 'ripro'); ?>" />
				</div>
