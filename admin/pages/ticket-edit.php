...
if (isset($_POST['save_record'])) {
    ...
    if (Capalot_Ticket::update($update, ['id' => $Data->id])) {
        $message = '工单更新成功';
        $Data = Capalot_Ticket::get($ticket_id);
    } else {
        $message = '工单更新失败';
                                ...
                                <table class="form-table editcomment" role="presentation">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div style=" background: #eee; padding: 10px; "><?php echo $Data->content; ?></div>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <div class="submitbox">
                                ...
                                <div id="major-publishing-actions">
                                    <div id="publishing-action">
                                        <input type="submit" name="save_record" class="button button-primary button-large" value="更新工单">
                                    </div>
                                    <div class="clear"></div>
                                </div>
                            </div>
